...
typedef struct {
	...
	unsigned char adc3L;
	unsigned char adc00H;       // ADC通道0数据
	unsigned char adc00L;
	unsigned char adc10H;       // ADC通道1数据
	unsigned char adc10L;
	unsigned char adc20H;       // ADC通道2数据
	unsigned char adc20L;
	unsigned char adc30H;        // ADC通道3数据
	unsigned char adc30L;
